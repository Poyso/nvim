...
-- k.set("n", "<C-e>", ':lua require("harpoon.ui").toggle_quick_menu()<cr>')
-- k.set("n", "<C-a>", ':lua require("harpoon.mark").add_file()<cr>')
-- k.set("n", "<C-b>", ':lua require("harpoon.ui").nav_next()<cr>')
-- k.set("n", "<C-v>", ':lua require("harpoon.ui").nav_prev()<cr>')
